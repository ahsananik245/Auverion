      ...
      <div className="container">
        ...
        <div className="benefits-grid">
          <div className="benefit-card">
            ...
            <div className="benefit-stat">60%</div>
          ...
          <div className="benefit-card">
            ...
            <div className="benefit-stat">0</div>
        ...
        <div className="stats-section">
          <div className="stats-bg-blueprint"></div>
          <div className="stats-grid">
            <div>
              <div className="stat-item-number">12,500+</div>
              <div className="stat-item-desc">Projects</div>
            </div>
            <div>
              <div className="stat-item-number">2M+</div>
              <div className="stat-item-desc">Hours Saved</div>
            </div>
            <div>
              <div className="stat-item-number">150M+</div>
              <div className="stat-item-desc">Bars Generated</div>
            </div>
            <div>
              <div className="stat-item-number">850k+</div>
              <div className="stat-item-desc">Drawings Exported</div>
            </div>
          </div>
        </div>

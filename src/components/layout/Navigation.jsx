        ...
        <div className="container">
          <div className="nav-content">
            <Link to="/" className="nav-logo" onClick={closeMobileMenu}>
              <img src="/logo-hero.png" alt="Auverion" style={{ height: '48px' }} />
            </Link>
            ...
            <div className="nav-actions hide-mobile hide-tablet">
              ...
              <Button variant="primary" as={Link} to="/download">Join Waitlist</Button>
            </div>
      ...
      <div className={`mobile-menu-overlay ${mobileMenuOpen ? 'open' : ''}`}>
        <div className="mobile-menu-content">
          ...
          <div className="mobile-nav-actions">
            ...
            <Button variant="primary" as={Link} to="/download" onClick={closeMobileMenu} style={{width: '100%'}}>Join Waitlist</Button>
          </div>
        </div>
      </div>
    </>
